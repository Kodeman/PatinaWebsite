        ...
        <div className="max-w-[600px] mx-auto text-center">
          ...
          <FadeIn>
            <h2 className="text-heading-1 text-[var(--patina-off-white)] mb-4">
              {appCTAContent.headline}{' '}
              <em className="italic text-[var(--patina-clay-beige)]">
                {appCTAContent.headlineEmphasis}
              </em>
            </h2>
          </FadeIn>
          ...
          {/* Subheadline */}
          <FadeIn delay={0.1}>
            <p className="text-lg text-[rgba(237,233,228,0.75)] mb-4">{appCTAContent.subheadline}</p>
          </FadeIn>

          {/* Tertiary line */}
          <FadeIn delay={0.15}>
            <p className="text-sm text-[rgba(237,233,228,0.6)] mb-10">{appCTAContent.tertiaryLine}</p>
          </FadeIn>
          ...
          <FadeIn delay={0.2}>
            ...
            >
              ...
              {appCTAContent.primaryCTA.label}
            </a>
          </FadeIn>
          ...
          <FadeIn delay={0.3}>
            <p className="mt-6 text-sm text-[rgba(237,233,228,0.5)]">
              {appCTAContent.secondaryText.split(appCTAContent.secondaryLink.label)[0]}
              <Link
                href={appCTAContent.secondaryLink.href}
                className="underline hover:text-[var(--patina-clay-beige)] transition-colors"
              >
                {appCTAContent.secondaryLink.label}
              </Link>
              {appCTAContent.secondaryText.split(appCTAContent.secondaryLink.label)[1]}
            </p>
          </FadeIn>
        </div>
      </Container>
