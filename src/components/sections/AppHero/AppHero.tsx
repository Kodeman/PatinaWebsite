        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.h1
              ...
              variants={itemVariants}
            >
              {appHeroContent.headline}
              <br />
              <em className="italic text-[var(--patina-mocha-brown)]">
                {appHeroContent.headlineEmphasis}
              </em>
            </motion.h1>
            ...
            >
              ...
              >
                ...
                {appHeroContent.primaryCTA.label}
              </a>
              ...
              >
                {appHeroContent.secondaryCTA.label}
                <svg
                  className="w-4 h-4"
                  fill="none"
                  viewBox="0 0 24 24"
